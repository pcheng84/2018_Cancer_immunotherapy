...
```{r, message = TRUE, warning = FALSE, echo = TRUE, eval = TRUE}
patients <- read.table("Derm_patients.txt", sep = "\t", header = TRUE)
treatment <- read.table("Derm_treatments.txt", sep = "\t", header = TRUE)
```
